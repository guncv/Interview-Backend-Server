...
ALTER TABLE users
    ADD CONSTRAINT users_provider_id_unique UNIQUE (provider_id, provider);
...
CREATE INDEX IF NOT EXISTS idx_users_provider_id_provider ON users(provider_id, provider);