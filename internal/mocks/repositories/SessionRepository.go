...
func (_m *MockSessionRepository) GetSessionByID(ctx context.Context, id string) (db.Sessions, error) {
	...
	var r0 db.Sessions
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (db.Sessions, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) db.Sessions); ok {
		r0 = rf(ctx, id)
	} else {
...
func (_c *MockSessionRepository_GetSessionByID_Call) RunAndReturn(run func(context.Context, string) (db.Sessions, error)) *MockSessionRepository_GetSessionByID_Call {
	_c.Call.Return(run)
	return _c
}

// RevokeSessionByID provides a mock function with given fields: ctx, id
func (_m *MockSessionRepository) RevokeSessionByID(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_c *MockSessionRepository_RevokeSessionByID_Call) Run(run func(ctx context.Context, id string)) *MockSessionRepository_RevokeSessionByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockSessionRepository_RevokeSessionByID_Call) RunAndReturn(run func(context.Context, string) error) *MockSessionRepository_RevokeSessionByID_Call {
	_c.Call.Return(run)
	return _c
}
