...
// UpdateFinalizeStatusSessionEvaluation provides a mock function with given fields: ctx, sessionID, finalizeStatus
func (_m *MockEvaluationService) UpdateFinalizeStatusSessionEvaluation(ctx context.Context, sessionID string, finalizeStatus db.FinalizeStatusEnum) error {
	ret := _m.Called(ctx, sessionID, finalizeStatus)

	if len(ret) == 0 {
		panic("no return value specified for UpdateFinalizeStatusSessionEvaluation")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, db.FinalizeStatusEnum) error); ok {
		r0 = rf(ctx, sessionID, finalizeStatus)
	} else {
		r0 = ret.Error(0)
	}
...
// MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateFinalizeStatusSessionEvaluation'
type MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call struct {
	*mock.Call
}

// UpdateFinalizeStatusSessionEvaluation is a helper method to define mock.On call
//   - ctx context.Context
//   - sessionID string
//   - finalizeStatus db.FinalizeStatusEnum
func (_e *MockEvaluationService_Expecter) UpdateFinalizeStatusSessionEvaluation(ctx interface{}, sessionID interface{}, finalizeStatus interface{}) *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call {
	return &MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call{Call: _e.mock.On("UpdateFinalizeStatusSessionEvaluation", ctx, sessionID, finalizeStatus)}
}

func (_c *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call) Run(run func(ctx context.Context, sessionID string, finalizeStatus db.FinalizeStatusEnum)) *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(db.FinalizeStatusEnum))
	})
	return _c
}

func (_c *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call) Return(_a0 error) *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call) RunAndReturn(run func(context.Context, string, db.FinalizeStatusEnum) error) *MockEvaluationService_UpdateFinalizeStatusSessionEvaluation_Call {
	_c.Call.Return(run)
	return _c
}
